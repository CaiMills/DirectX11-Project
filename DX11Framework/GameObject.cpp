...
void GameObject::Update(float deltaTime)
{
	...
	XMMATRIX rotation = XMMatrixRotationX(GetTransform()->GetRotation().x) * XMMatrixRotationY(GetTransform()->GetRotation().y) * XMMatrixRotationZ(GetTransform()->GetRotation().z);
